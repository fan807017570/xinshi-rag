...
#
# 用法：
#   bash rag/docker-install/build.sh              # 构建，tag = xinshi-rag:latest
#   bash rag/docker-install/build.sh 1.2.0        # 构建，tag = xinshi-rag:1.2.0 + latest
#   bash rag/docker-install/build.sh 1.2.0 --push # 构建并推送到镜像仓库
#
# 环境变量（启动前 export）：
